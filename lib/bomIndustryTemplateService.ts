...
const TEMPLATES: Record<string, BomIndustryTemplate> = {
  ...
  "CPO / 共封装光学": {
    industry:   "CPO / 共封装光学",
    industryId: "cpo",
    description: "共封装光学(CPO)是将光引擎与交换芯片共同封装，大幅降低数据中心内部光互联功耗和延迟；800G/1.6T光模块是当前AI算力基础设施核心器件，CPO是更长期的技术路径",
    totalCost: "800G光模块约800-1500美元，CPO模块成本结构仍在演进",
    updatedAt: "2025-08",
    modules: [
      {
        id: "cpo-chip",
        moduleName: "光芯片/激光器(CW光源/EML)",
        estimatedCostRatioMin: 30, estimatedCostRatioMax: 45,
        technicalBarrier: "高", localizationSpace: "大",
        pricingPower: "强", grossMarginPotential: "高",
        rawMaterialSensitivity: "中",
        keyMaterials: ["InP衬底", "磷化铟外延片", "硅光晶圆"],
        nameKeywords: ["源杰", "长光华芯", "仕佳光子", "光库", "华工科技"],
        industryKeywords: ["光芯片", "激光器", "CW激光", "EML", "硅光子"],
        businessKeywords: ["EML激光器芯片", "CW连续光源", "硅光芯片", "InP芯片"],
        representativeStocks: [
          { tsCode: "688498.SH", symbol: "688498", name: "源杰科技",  note: "国内EML/CW激光器芯片龙头" },
          { tsCode: "688048.SH", symbol: "688048", name: "长光华芯", note: "半导体激光芯片，布局CPO" },
          { tsCode: "688313.SH", symbol: "688313", name: "仕佳光子",  note: "光芯片/AWG/硅光，CPO旗手" },
          { tsCode: "300620.SZ", symbol: "300620", name: "光库科技",  note: "硅光+光引擎，CPO核心器件" },
        ],
        investmentLogic: "光芯片是CPO和高速光模块最核心元器件，占成本30-45%。InP激光器和硅光芯片高度依赖进口，国产替代空间最大，但技术突破周期较长",
        risks: ["InP/硅光技术突破难度大", "与国际头部企业差距较大", "业绩波动剧烈"],
        opportunities: ["国产替代迫切性强", "AI算力爆发推动光芯片需求", "硅光量产突破带来降本"],
      },
      {
        id: "cpo-module",
        moduleName: "高速光模块/光收发器",
        estimatedCostRatioMin: 20, estimatedCostRatioMax: 35,
        technicalBarrier: "高", localizationSpace: "中",
        pricingPower: "较强", grossMarginPotential: "高",
        rawMaterialSensitivity: "中",
        keyMaterials: ["光芯片", "驱动IC/TIA", "高速PCB", "封装材料"],
        nameKeywords: ["中际旭创", "新易盛", "光迅科技", "华工科技", "剑桥科技", "联特科技", "博创科技"],
        industryKeywords: ["光模块", "光收发器", "800G", "1.6T", "高速光通信"],
        businessKeywords: ["800G光模块", "1.6T光模块", "CPO光引擎", "数据中心光互联"],
        representativeStocks: [
          { tsCode: "300308.SZ", symbol: "300308", name: "中际旭创", note: "光模块绝对龙头，800G/1.6T" },
          { tsCode: "300502.SZ", symbol: "300502", name: "新易盛",   note: "高速光模块核心，AI受益弹性大" },
          { tsCode: "002281.SZ", symbol: "002281", name: "光迅科技", note: "光模块+光芯片自研" },
          { tsCode: "000988.SZ", symbol: "000988", name: "华工科技", note: "光模块+激光综合布局" },
        ],
        investmentLogic: "高速光模块是AI数据中心高速互联最直接受益标的，800G向1.6T升级+CPO商业化是2025-2027年核心逻辑；国内龙头海外大客户份额持续提升",
        risks: ["海外大客户高集中度", "光模块价格竞争加剧", "AI算力需求波动"],
        opportunities: ["1.6T/CPO新产品周期", "国内算力数据中心建设", "份额从海外老牌厂商获取"],
      },
      {
        id: "cpo-component",
        moduleName: "光无源器件/光引擎",
        estimatedCostRatioMin: 15, estimatedCostRatioMax: 25,
        technicalBarrier: "高", localizationSpace: "中高",
        pricingPower: "较强", grossMarginPotential: "高",
        rawMaterialSensitivity: "低",
        keyMaterials: ["铌酸锂晶体", "透镜", "精密陶瓷套管"],
        nameKeywords: ["天孚通信", "太辰光", "联特科技", "博创科技"],
        industryKeywords: ["光无源器件", "光引擎", "光连接器", "AWG"],
        businessKeywords: ["光无源器件", "光引擎", "光连接耦合", "AWG芯片"],
        representativeStocks: [
          { tsCode: "300394.SZ", symbol: "300394", name: "天孚通信",  note: "光无源器件龙头，CPO核心配套" },
          { tsCode: "300570.SZ", symbol: "300570", name: "太辰光",    note: "光连接器+光无源器件" },
          { tsCode: "301205.SZ", symbol: "301205", name: "联特科技",  note: "光模块+光器件双主业" },
          { tsCode: "300548.SZ", symbol: "300548", name: "博创科技",  note: "光模块+光引擎布局" },
        ],
        investmentLogic: "光无源器件和光引擎是CPO方案关键配套环节，毛利率高于光模块整机，技术壁垒强；随CPO商业化推进，光引擎重要性持续提升",
        risks: ["CPO商业化节奏不确定", "光引擎标准化进度", "依赖少数优质客户"],
        opportunities: ["CPO放量带动光引擎需求", "国产光无源器件进一步提升份额"],
      },
      {
        id: "cpo-fiber",
        moduleName: "光纤/高速互联配套",
        estimatedCostRatioMin: 5, estimatedCostRatioMax: 12,
        technicalBarrier: "中", localizationSpace: "中",
        pricingPower: "中", grossMarginPotential: "中",
        rawMaterialSensitivity: "中",
        keyMaterials: ["光纤预制棒", "硅烷", "氮化硅"],
        nameKeywords: ["亨通光电", "中天科技", "烽火通信", "长飞光纤"],
        industryKeywords: ["光纤光缆", "高速互联", "数据中心互联"],
        businessKeywords: ["数据中心光纤", "预制光缆", "高速互联光缆"],
        representativeStocks: [
          { tsCode: "600487.SH", symbol: "600487", name: "亨通光电",  note: "光纤光缆龙头，AI机房光纤受益" },
          { tsCode: "600522.SH", symbol: "600522", name: "中天科技",  note: "光纤光缆+海缆综合" },
          { tsCode: "601869.SH", symbol: "601869", name: "长飞光纤",  note: "光纤光缆全球前三" },
        ],
        investmentLogic: "数据中心光纤用量随AI算力密度提升而增加，但直接受益弹性低于光模块；关注数据中心预制光缆和高密度光纤解决方案",
        risks: ["与光模块相比AI受益弹性偏低", "产品同质化竞争", "量增价跌可能"],
        opportunities: ["AI数据中心光纤用量提升", "海底光缆需求"],
      },
      {
        id: "cpo-packaging",
        moduleName: "先进封装/光电集成测试",
        estimatedCostRatioMin: 8, estimatedCostRatioMax: 15,
        technicalBarrier: "高", localizationSpace: "大",
        pricingPower: "较强", grossMarginPotential: "高",
        rawMaterialSensitivity: "低",
        keyMaterials: ["有机基板", "焊球", "键合线"],
        nameKeywords: ["华天科技", "长电科技", "通富微电", "罗博特科", "精测电子"],
        industryKeywords: ["先进封装", "光电集成封装", "CPO封装", "光通信测试"],
        businessKeywords: ["先进封装", "光电共封装", "CPO封装测试", "硅光封装"],
        representativeStocks: [
          { tsCode: "300757.SZ", symbol: "300757", name: "罗博特科", note: "光通信设备+CPO封装自动化" },
          { tsCode: "002185.SZ", symbol: "002185", name: "华天科技", note: "先进封装，光电集成布局" },
          { tsCode: "600584.SH", symbol: "600584", name: "长电科技", note: "国内最大封装测试，先进封装受益" },
          { tsCode: "300456.SZ", symbol: "300456", name: "赛微电子", note: "MEMS+硅光子晶圆代工" },
        ],
        investmentLogic: "先进封装是CPO产业化核心能力，光芯片与交换芯片的共封装对封装精度要求极高；国内先进封装实力持续提升，国产替代空间大",
        risks: ["CPO封装技术难度极高", "产业化时间表不确定", "研发投入持续"],
        opportunities: ["CPO产业化推进带来新市场", "国产替代先进封装进口"],
      },
      {
        id: "cpo-infra",
        moduleName: "数据中心散热/电源基础设施",
        estimatedCostRatioMin: 5, estimatedCostRatioMax: 10,
        technicalBarrier: "中", localizationSpace: "中高",
        pricingPower: "中", grossMarginPotential: "中",
        rawMaterialSensitivity: "中",
        keyMaterials: ["压缩机", "换热器", "电池", "逆变器"],
        nameKeywords: ["英维克", "申菱环境", "科华数据", "科士达"],
        industryKeywords: ["数据中心散热", "精密空调", "UPS电源"],
        businessKeywords: ["数据中心精密空调", "液冷散热", "UPS不间断电源", "模块化电源"],
        representativeStocks: [
          { tsCode: "002837.SZ", symbol: "002837", name: "英维克",   note: "数据中心精密空调龙头，液冷" },
          { tsCode: "002335.SZ", symbol: "002335", name: "科华数据", note: "UPS电源+新能源储能" },
          { tsCode: "002518.SZ", symbol: "002518", name: "科士达",   note: "数据中心UPS电源" },
        ],
        investmentLogic: "AI数据中心功耗密度大幅提升，传统风冷难以满足需求，液冷散热和高效电源受益；CPO模块集成化降低光互联能耗，但整体算力功耗仍快速增长",
        risks: ["受益为间接/配套性质", "竞争格局分散", "毛利率偏低"],
        opportunities: ["液冷渗透率快速提升", "AI数据中心建设加速"],
      },
    ],
  },
