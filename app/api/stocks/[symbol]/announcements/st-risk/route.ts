/**
 * app/api/stocks/[symbol]/announcements/st-risk/route.ts
 *
 * GET /api/stocks/:symbol/announcements/st-risk
 * ST 专项风险公告（stub）
 */

import { NextRequest, NextResponse } from "next/server";
import { getSTRiskAnnouncements } from "@/lib/announcementService";
...
export async function GET(
  ...
  const result = await getSTRiskAnnouncements(symbolToTsCode(sym));
