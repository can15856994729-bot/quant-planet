/**
 * app/api/stocks/[symbol]/announcements/dividend/route.ts
 *
 * GET /api/stocks/:symbol/announcements/dividend
 * 分红公告（stub）
 */

import { NextRequest, NextResponse } from "next/server";
import { getDividendAnnouncements } from "@/lib/announcementService";
...
export async function GET(
  ...
  const result = await getDividendAnnouncements(symbolToTsCode(sym));
